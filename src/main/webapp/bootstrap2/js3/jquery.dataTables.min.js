...
function X(a) {
            var b,
                ...
                d = {};
            h.each(a, function (e) {
                if ((b = e.match(/^([^A-Z]+?)([A-Z])/)) && -1 !== "a aa ai ao as b fn i m o s ".indexOf(
                    b[1] + " "
                )) 
        ...
        function Da(a) {
            var b = m.defaults.oLanguage,
                c = a.sZeroRecords;
            !a.sEmptyTable && (c && "No data available in table" === b.sEmptyTable) && E(
                a,
                a,
                "sZeroRecords",
                "sEmptyTable"
            );
            !a.sLoadingRecords && (c && "Loading..." === b.sLoadingRecords) && E(
                a,
                a,
                "sZeroRecords",
                "sLoadingRecords"
        ...
        function gb(a) {
            if (!m.__browser) {
                ...
                var c = h("<div/>")
                        ...
                        .append(
                            h("<div/>").css({left: 1, overflow: "scroll", position: "absolute", top: 1, width: 100}).append(h("<div/>").css({height: 10, width: "100%"}))
                        )
                        .appendTo("body"),
                    d = c.children(),
                    e = d.children();
        ...
        function B(a, b, c, d) {
            ...
            if (i === k) 
                return a.iDrawError != e && null === j && (
                    L(a, 0, "Requested unknown parameter " + (
...
- 1 != d && c === k && a.splice(d, 1)
            ...
            var e = [],
                ...
                S = function (a) {
                    if (c === k || c === i) 
                        ...
                        j && j._bAttrSrc
                            ? (R(j.mData._)(d, n), t(j.mData.sort, a), t(j.mData.type, a), t(
                                j.mData.filter,
                                a
                            ))
                            : q
        ...
        function Ha(a, b, c, d) {
            ...
            if (null === e.nTr) {
                ...
                for (q = a.aoColumns.length; l < q; l++) {
                    ...
                    n.fnCreatedCell && n
                        .fnCreatedCell
                        .call(a.oInstance, i, B(a, b, l), f, b, l)
                }
        ...
        function ra(a, b, c) {
            ...
            a.fnServerData
                ? a
                    .fnServerData
                    .call(j, a.sAjaxSource, h.map(b, function (a, b) {
        ...
        function lb(a) {
            return a.bAjaxDataGet
                ? (a.iDraw++, C(a, !0), ra(a, ub(a), function (b) {
                    vb(a, b)
                }), !1)
                : !0
        }
        function ub(a) {
            ...
            for (g = 0; g < c; g++) 
                ...
                k("mDataProp_" + g, i),
                d.bFilter && (k("sSearch_" + g, l.sSearch), k("bRegex_" + g, l.bRegex), k(
                    "bSearchable_" + g,
                    n.bSearchable
                )),
        ...
        function Ab(a) {
            return {caseInsensitive: a.bCaseInsensitive, regex: a.bRegex, search: a.sSearch, smart: a.bSmart}
        }
        function Bb(a) {
            return {bCaseInsensitive: a.caseInsensitive, bRegex: a.regex, bSmart: a.smart, sSearch: a.search}
        }
        function sb(a) {
            var b = a.sTableId,
                c = a.aanFeatures.i,
        ...
        function Db(a, b) {
            ...
            return b
                ...
                .replace(/_PAGE_/g, c.call(
                    a,
                    g
                        ? 1
                        : Math.ceil(d / e)
                ))
                .replace(/_PAGES_/g, c.call(
                    a,
                    g
                        ? 1
                        : Math.ceil(f / e)
        ...
        function C(a, b) {
            a.oFeatures.bProcessing && h(a.aanFeatures.r).css(
                "display",
                b
                    ? "block"
                    : "none"
        ...
        function rb(a) {
            ...
            i = h("<div/>", {"class": f.sScrollWrapper})
                ...
                .append(h("<div/>", {"class": f.sScrollBody}).css({
                    overflow: "auto",
                    position: "relative",
                    width   : !d
                        ? null
            ...
            l && i.append(h("<div/>", {"class": f.sScrollFoot}).css({
                ...
                width   : d
                    ? !d
                        ...
                        : x(d)
                    : "100%"
            }).append(h("<div/>", {"class": f.sScrollFootInner}).append(n.removeAttr("id").css("margin-left", 0).append(
                "bottom" === j
                    ? g
                    : null
        ...
        function ka(a) {
            ...
            if (a.scrollBarVis !== v && a.scrollBarVis !== k) 
                ...
                if (F.outerWidth() < f) {
                    P = j.scrollHeight > j.offsetHeight || "scroll" == l.css("overflow-y")
                        ? f + b
                        : f;
        ...
        function Fa(a) {
            ...
            if (d || !t && !f && !e && j == aa(a) && j == n.length) 
                ...
                j
                    ...
                    .remove();
                j
                    .append(h(a.nTHead).clone())
                    .append(h(a.nTFoot).clone());
                j
                    .find("tfoot th, tfoot td")
                    .css("width", "");
                n = qa(a, j.find("thead")[0]);
                for (m = 0; m < i.length; m++) 
                    o = c[i[m]],
                    n[m].style.width = null !== o.sWidthOrig && "" !== o.sWidthOrig
                        ? x(o.sWidthOrig)
                        : "",
                    o.sWidthOrig && f && h(n[m]).append(
                        h("<div/>").css({border: 0, height: 1, margin: 0, padding: 0, width: o.sWidthOrig})
                    );
                if (a.aoData.length) 
                    for (m = 0; m < i.length; m++) 
                        t = i[m],
        ...
        function va(a) {
            ...
            if (e.bSort && e.bSortClasses) {
                ...
                for (f = b.length; e < f; e++) 
                    g = b[e].src,
                    h(G(a.aoData, "anCells", g)).removeClass(c + (
                        2 > e
                            ? e + 1
                            : 3
                    ));
                ...
                for (f = d.length; e < f; e++) 
                    g = d[e].src,
                    h(G(a.aoData, "anCells", g)).addClass(c + (
                        2 > e
                            ? e + 1
                            : 3
                    ))
            ...
            for (e in b) 
                b.hasOwnProperty(e) && (
                    ...
                    h.isPlainObject(d)
                        ...
                        : a[e] = c && "data" !== e && "aaData" !== e && h.isArray(d)
                            ? d.slice()
                            : d
                );
            return a
        ...
        var m = function (a) {
            ...
            this.each(function () {
                    ...
                    if ("table" != this.nodeName.toLowerCase()) 
                        ...
                        e.aLengthMenu && !e.iDisplayLength && (
                        ...
                        e = Lb(h.extend(!0, {}, l), e);
                        E(o.oFeatures, e, (
                            "bPaginate bLengthChange bFilter bSort bSortMulti bInfo bProcessing bAutoWidth " +
                            "bSortClasses bServerSide bDeferRender"
                        ).split(" "));
                        E(o, e, [
                            "asStripeClasses",
                            "ajax",
                        ...
                        e.bJQueryUI
                            ? (
                                ...
                                ? h.isPlainObject(o.renderer) && !o.renderer.header && (
    ...
    h.extend(r.prototype, {
            ...
            return e.length || d
                ? (a = new r(
                    ...
                    a
                        ? e.concat.apply([], e)
                        : e
                ), b = a.selector, b.rows = p.rows, b.cols = p.cols, b.opts = p.opts, a)
                : this
        },
        join       : w.join,
        lastIndexOf: w.lastIndexOf || function (a, b) {
            return this
                .indexOf
                .apply(this.toArray.reverse(), arguments)
        },
        length     : 0,
        map        : function (a) {
            var b = [];
            ...
            return this.iterator("table", function (b) {
                ...
                return $a("cell", d, function (a) {
                    ...
                    c = i
                        .filter(a)
                        .map(function (a, b) {
                            return {column: b._DT_CellIndex.column, row: b._DT_CellIndex.row}
                        })
                        .toArray();
    ...
    h.extend(m.ext.oJUIClasses, m.ext.classes, {
        ...
        sPaging            : "dataTables_paginate fg-buttonset ui-buttonset fg-buttonset-multi ui-buttonset-" +
                "multi paging_",
                ...
                h(a.nTable).on("order.dt.DT", function (e, f, g, h) {
                    if (a === f) {
                        ...
                        b
                            ...
                            .removeClass(
                                d.sSortJUIAsc + " " + d.sSortJUIDesc + " " + d.sSortJUI + " " + d.sSortJUIAscAllowed +
