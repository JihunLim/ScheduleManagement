                                ...
                                <div class="col-lg-6">
                                   <h2>과제 기본 설정</h2>
                                        ...
                                        <div class="form-group">
                                            <label>과제명</label>
                                            <input class="form-control" type="text" name="task_name"  value="${task_name}"/>
                                            
                                        </div>
                                        <div class="form-group">
                                            <label>지시문</label>
                                            <input class="form-control" type="text" name="task_indicator" placeholder="지시문을 입력하세요"/>
                                        </div>
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="form-group">
                                        	...
                                        	<input class="form-control timepicker" type="text" id="mytimepicker1" name="task_createTime1"/>
                                      	</div>
                                      	</div>
