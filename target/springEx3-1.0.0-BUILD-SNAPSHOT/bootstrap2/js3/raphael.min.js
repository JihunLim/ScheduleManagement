                ...
                n = function (t) {
                    function e(r) {
                        if (e.is(r, "function")) 
                            return w
                                ? r()
                                : t.on("raphael.DOMload", r);
                        if (e.is(r, Q)) 
                            return e
                                ._engine
                                .create[z](e, r.splice(0, 3 + e.is(r[0], $)))
                                .add(r);
                        var i = Array
                            .prototype
                            .slice
                    ...
                    function b(r, i, n, a, s, o) {
                        ...
                        if (l) {
                                            ...
                                            case "transform":
                                                ...
                                                if (z) 
                                                    for (
                                                        ...
                                                        for (b[C][w] = [v[C][w][0]], N = 1, M = v[C][w].length; M > N; N++) 
                            ...
                            if (d = l.start || r.start ||+ new Date, _ = {
                                    ...
                                    to         : m,
                                    totalOrigin: s
                                }, Ee.push(_), a && !h && !u && (_.stop = !0, _.start = new Date - x * a, 1 == Ee.length)) 
                                    return Me();
                    ...
                    var w,
                        ...
                        j  = String,
                        q  = "split",
                        D  = "click dblclick mousedown mousemove mouseout mouseover mouseup touchstart touch" +
                                "move touchend touchcancel" [q](I),
                        V  = {
                    ...
                    if (
                        e._g   = A,
                        e.type = A.win.SVGAngle || A.doc.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1")
                            ? "SVG"
                            : "VML",
                        "VML" == e.type
                    ) {
                        ...
                        "finite" == e
                            ...
                            : "array" == e
                                ...
                                : "null" == e && null === t || e == typeof t && null !== t || "object" == e && t === Object(
                                    t
                                ) || "array" == e && Array.isArray && Array.isArray(t) || tt
                                    .call(t)
                                    .slice(8, -1)
                                    .toLowerCase() == e
                    },
                    ...
                    e.getRGB               = n(function (t) {
                        ...
                        if ("none" == t) 
                            return {b: -1, g: -1, hex: "none", r: -1, toString: a};
                        ...
                        return u
                            ? (
                                ...
                                u[3] && (s = ut((l = u[3].charAt(3)) + l, 16), n = ut(
                                    (l = u[3].charAt(2)) + l,
                                    16
                                ...
                                u[5]
                                    ...
                                    : u[6]
                                        ...
                                        : (u = {
                                            ...
                                            16777216 | s | n << 8 | i << 16
                                        ).toString(16).slice(1), e.is(o, "finite") && (u.opacity = o), u)
                            )
                            : {
                                b       : -1,
                                error   : 1,
                    ...
                    e.parsePathString      = function (t) {
                        ...
                        n.length || j(t).replace(yt, function (t, e, r) {
                            var a = [],
                                s = e.toLowerCase();
                    ...
                    e.parseTransformString = n(function (t) {
                        ...
                        i.length || j(t).replace(mt, function (t, e, r) {
                            var n = [],
                                a = O.call(e);
                    ...
                    var Vt = function (t) {
                        ...
                        setTimeout(function () {
                            for (var r in e) 
                                e[T](r) && r != t && (e[r].sleep--, !e[r].sleep && delete e[r])
                        }),
                        e[t]
                    };
                    ...
                    var Ot = e.pathBBox = function (t) {
                                ...
                                if (i.push(c = []), f = t[p], f[0] != ct.call(f[0])) 
                                    switch (c[0] = ct.call(f[0]), c[0]) {
                                        ...
                                        case "H":
                                            ...
                                            break;
                                        case "R":
                                            for (var g = [n, a][P](f.slice(1)), x = 2, v = g.length; v > x; x++) 
                                                g[x]   = +g[x] + n,
                                                g[++x] = +g[x] + a;
                                            i.pop(),
                                            i = i[P](s(g, u));
                        ...
                        Qt = e._path2curve = n(function (t, e) {
                            ...
                            for (
                                ...
                                p     = "",
                                d     = 0,
                                g     = W(i.length, n && n.length || 0); g > d; d++
                            ) {
                                i[d] && (f = i[d][0]),
                                "C" != f && (u[d] = f, d && (p = u[d - 1])),
                                i[d] = o(i[d], a, p),
                    ...
                    function (t) {
                        ...
                        t.split             = function () {
                            ...
                            var a = -n[0][1],
                                s = n[1][1];
                            return 0 > s
                                ? (t.rotate = e.deg(Y.acos(s)), 0 > a && (t.rotate = 360 - t.rotate))
                    ...
                    ye.drag       = function (r, i, n, a, s, o) {
                        function l(l) {
                            ...
                            !ge.length && e
                                .mousemove(xe)
                                .mouseup(ve),
                            ge.push({el: this, end_scope: o, move_scope: a, start_scope: s}),
                    ...
                    ye.undrag     = function () {
                        for (var r = be.length; r--;) 
                            be[r].el == this && (this.unmousedown(be[r].start), be.splice(r, 1), t.unbind(
                    ...
                    M.path        = function (t) {
                        ...
                        var r = e
                            ._engine
                            .path(e.format[z](e, arguments), this);
                        return this.__set__ && this
                            .__set__
                            .push(r),
                        r
                                ...
                                for (var s, o, l, h, u = "", c = {}, f, p = 0, d = 0, g = i.length; g > d; d++) {
                                    if (l = i[d], "M" == l[0]) 
                                        ...
                                        if (h = ke(s, o, l[1], l[2], l[3], l[4], l[5], l[6]), p + h > n) {
                                            if (r && !c.start) {
                                                if (f = ke(s, o, l[1], l[2], l[3], l[4], l[5], l[6], n - p), u += [
                                                    "C" + f.start.x,
                                                    f.start.y,
                                                    f.m.x,
                                                    f.m.y,
                        ...
                        bounce : function (t) {
                            ...
                            return 1 / r > t
                                ...
                                : 2 / r > t
                                    ? (t -= 1.5 / r, i = e * t * t + .75)
                                    : 2.5 / r > t
                                        ? (t -= 2.25 / r, i = e * t * t + .9375)
                                        : (t -= 2.625 / r, i = e * t * t + .984375),
                            i
                        },
                        elastic: function (t) {
                            return t == !!t
                                ? t
                                : X(2, -10 * t) * Y.sin((t - .075) * (2 * U) / .3) + 1
                        },
                        linear : function (t) {
                            return t
                        }
                    ...
                    var Ee = [],
                        Ne = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (
                            t
                        ) {
                            setTimeout(t, 16)
                        },
                    ...
                    e.animation        = function (t, r, i, n) {
                        ...
                        var a = {},
                            ...
                            o;
                        for (o in t) 
                            t[T](o) && ht(o) != o && ht(o) + "%" != o && (s = !0, a[o] = t[o]);
                        if (s) 
                            return i && (a.easing = i),
                            n && (a.callback = n),
                            new m({
                    ...
                    ye.pause           = function (e) {
                        for (var r = 0; r < Ee.length; r++) 
                            Ee[r].el.id != this.id || e && Ee[r].anim != e || t(
                    ...
                    var ze = function (t) {
                            if (this.items = [], this.length = 0, this.type = "set", t) 
                                for (var e = 0, r = t.length; r > e; e++) 
                                    !t[e] || t[e].constructor != ye.constructor && t[e].constructor != ze || (
                    ...
                    Pe.push    = function () {
                        for (var t, e, r = 0, i = arguments.length; i > r; r++) 
                            t = arguments[r],
                            !t || t.constructor != ye.constructor && t.constructor != ze || (
                                e                       = this.items.length,
                    ...
                    function (t, r, i) {
                        ...
                        null == t.readyState && t.addEventListener && (
                            t.addEventListener(r, i = function () {
            ...
            function (t, e, r) {
                ...
                d.on            = function (t, e) {
                    ...
                    for (var r = t.split(o), i = p, n = 0, a = r.length; a > n; n++) 
                        i = i.n,
                        i = i.hasOwnProperty(r[n]) && i[r[n]] || (i[r[n]] = {
                            n: {}
                        });
                    ...
                    var x = function (i, n) {
                            if (n) {
                                ...
                                i = t
                                    ._g
                                    .doc
                                    .createElementNS("http://www.w3.org/2000/svg", i),
                            ...
                            if ("path" == i.type) {
                                ...
                                if (
                                    ...
                                    A
                                        ...
                                        }), A.appendChild(E), o.defs.appendChild(A), g[T] = 1),
                                    x(E, w);
                                ...
                                if (a[e](d)) {
                                    ...
                                    switch (u[d] = g, d) {
                                            ...
                                            if (!g) {
                                                ...
                                                if (E) {
                                                    var N = t
                                                        ._g
                                                        .doc
                                                        .getElementById(E.replace(/(^url\(#|\)$)/g, c));
                                                    N && N
                                                        .parentNode
                                                        .removeChild(N),
                                                    x(l, {"clip-path": c}),
                                        ...
                                        case "stroke":
                                            ...
                                            "stroke" == d && z[e]("opacity") && x(l, {
                                                "stroke-opacity": z.opacity > 1
                                                    ? z.opacity / 100
                                                    : z.opacity
                                            }),
                                            "stroke" == d && i._.arrows && (
                ...
                if (!t || t.vml) {
                    var e = "hasOwnProperty",
                        ...
                        C = function (t, e, r, i, n, a) {
                            ...
                            if (f.visibility = "hidden", e && r) {
                                if (c.coordsize = l(v) + p + l(y), f.rotation = a * (
                                    0 > e * r
                                        ? -1
                                        : 1
                                ), a) {
                    ...
                    var S = function (t, e, i) {
                        ...
                        T = function (n, l) {
                            ...
                            var c = n.node,
                                ...
                                x,
                                v = _[n.type] && (
                                    l.x != f.x || l.y != f.y || l.width != f.width || l.height != f.height || l.cx != f.cx || l.cy != f.cy || l.rx != f.rx || l.ry != f.ry || l.r != f.r
                                ),
                                y = w[n.type] && (
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    if (q) {
                                        ...
                                        t
                                            ...
                                            circle : 1,
                                            ellipse: 1
                                        } || "r" != r(l.fill).charAt()) && A(m, l.fill, I) && (
                                            f.fill     = "none",
                                            f.gradient = l.fill,
                                            I.rotate   = !1
                                        )
                                ...
                                if ("fill-opacity" in l || "opacity" in l) {
                                    var V = ((+f["fill-opacity"] + 1 || 2) - 1) * ((+f.opacity + 1 || 2) - 1) * (
                                ...
                                V = ((+f["stroke-opacity"] + 1 || 2) - 1) * ((+f.opacity + 1 || 2) - 1) * (
                                    (+W.o + 1 || 2) - 1
                                );
                            ...
                            if ("text" == m.type) {
                                ...
                                g.fontSize = $ * U + "px",
                                m.textpath.string && (
                                    X.innerHTML = r(m.textpath.string).replace(/</g, "&#60;").replace(/&/g, "&#38;").replace(/\n/g, "<br>")
                                );
                    ...
                    N.transform          = function (e) {
                        ...
                        if (s.translate(1, 1), c || u || "image" == this.type) 
                            ...
                            o.matrix       = r(s),
                            o.offset       = s.offset();
                        return null !== a && (this._.transform = a, t._extractTransform(this, a)),
                        this
                    },
                    ...
                    N.remove             = function () {
                        if (!this.removed && this.node.parentNode) {
                            this.paper.__set__ && this
                                .paper
                                .__set__
                                .exclude(this),
                            t
                                .eve
                                .unbind("raphael.*.*." + this.id),
