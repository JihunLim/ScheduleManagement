...
Lic
 * ensed under the BSD-2-Clause License.
...
(function () {
    ...
    b.Grid             = function (c) {
        function d(b) {
            ...
            var c = this;
            if (
                this.el = "string" == typeof b.element
                ...
                .bind("mousemove", function (a) {
                    ...
                    c.selectFrom
                        ? (
                            ...
                            f = e - b,
                            c.selectionRect.attr({width: f, x: b})
                        )
            ...
            this
                ...
                .bind("mouseleave", function () {
                    return c.selectFrom && (c.selectionRect.hide(), c.selectFrom = null),
                    c.fire("hoverout")
                }),
            this
                .el
                .bind("touchstart touchmove touchend", function (a) {
                    var b,
                        d;
                    return d = a
                        .originalEvent
        ...
        d.prototype.autoGridLines  = function (a, b, c) {
            ...
            d        = Math.ceil(b / j) * j,
            i        = (d - e) / (c - 1),
            1 === j && i > 1 && Math.ceil(i) !== i && (
                i = Math.ceil(i),
                d = e + i * (c - 1)
            ),
            0 > e && d > 0 && (e = Math.floor(a / i) * i, d = Math.ceil(b / i) * i),
            1 > i
                ? (g = Math.floor(Math.log(i) / Math.log(10)), f = function () {
                    var a,
                        b;
                    for (
                        b     = [],
        ...
        d.prototype._calc          = function () {
            ...
            (this.elementWidth !== e || this.elementHeight !== c || this.dirty) && (
                ...
                ((g = this.options.axes) === !0 || "both" === g || "y" === g) && (f = function () {
                    ...
                    return e
                }.call(this), this.left += Math.max.apply(Math, f)),
                ((h = this.options.axes) === !0 || "both" === h || "x" === h) && (a = function () {
                    ...
                    return c
                }.call(this), this.bottom -= Math.max.apply(Math, a)),
        ...
        d.prototype.drawGrid       = function () {
            ...
            if (this.options.grid !== !1 || (e = this.options.axes) === !0 || "both" === e || "y" === e) {
                for (f = this.grid, h = [], c = 0, d = f.length; d > c; c++) 
                    a = f[c],
                    b = this.transY(a),
                    ((g = this.options.axes) === !0 || "both" === g || "y" === g) && this.drawYAxisLabel(
                        this.left - this.options.padding / 2,
                        b,
                        this.yAxisFormat(a)
                    ),
                    this.options.grid
                        ? h.push(this.drawGridLine("M" + this.left + "," + b + "H" + (
        ...
        d.prototype.drawGoals      = function () {
            ...
            for (f = this.options.goals, g = [], c = d = 0, e = f.length; e > d; c = ++d) 
                ...
                a = this
                    .options
                    .goalLineColors[c % this.options.goalLineColors.length],
        ...
        d.prototype.drawEvents     = function () {
            ...
            for (f = this.events, g = [], c = d = 0, e = f.length; e > d; c = ++d) 
                ...
                a = this
                    .options
                    .eventLineColors[c % this.options.eventLineColors.length],
        ...
        d.prototype.resizeHandler  = function () {
            ...
            this
                .raphael
                .setSize(this.el.width(), this.el.height()),
            this.redraw()
        },
        d
    }(b.EventEmitter),
    ...
    b.Line             = function (a) {
        ...
        c.prototype.hoverContentForRow        = function (a) {
            ...
            for (
                ...
                e = h[c],
                b += "<div class='morris-hover-point' style='color: " + this.colorFor(
                    d,
                    c,
                    "label"
                ) + "'>\n  " + this
        ...
        c.prototype.generatePaths             = function () {
            ...
            return this.paths = function () {
                ...
                for (
                    j     = [],
                    c     = f = 0,
                    g     = this.options.ykeys.length; g >= 0
                            ? g > f
                            : f > g; c = g >= 0
                        ? ++f
                        : --f
                ) 
                    e = "boolean" == typeof this.options.smooth
                        ? this.options.smooth
            ...
            for (
                ...
                a = function (a, b) {
                    ...
                    0 !== l.options.xLabelAngle && (
                        i = -.5 * j.width * Math.cos(l.options.xLabelAngle * Math.PI / 180),
                        c.transform(
                            "t" + i + ",0..."
                        )
                    ),
                    d = c.getBBox(),
                    (null == f || f >= d.x + d.width || null != e && e >= d.x) && d.x >= 0 && d.x + d.width < l
                        .el
                        .width()
                            ? (0 !== l.options.xLabelAngle && (
        ...
        c.prototype.drawSeries                = function () {
            ...
            for (
                this.seriesPoints = [],
                a                 = b             = d         = this.options.ykeys.length - 1; 0 >= d
                        ? 0 >= b
                        : b >= 0; a = 0 >= d
                    ? ++b
                    : --b
            ...
            for (
                f         = [],
                a         = c     = e = this.options.ykeys.length - 1; 0 >= e
                        ? 0 >= c
                        : c >= 0; a = 0 >= e
                    ? ++c
                    : --c
        ...
        c.prototype.hilight                   = function (a) {
            ...
            if (null !== this.prevHilight && this.prevHilight !== a) 
                for (
                    b     = c = 0,
                    e     = this.seriesPoints.length - 1; e >= 0
                            ? e >= c
                            : c >= e; b = e >= 0
                        ? ++c
                        : --c
                ) 
                    this.seriesPoints[b][this.prevHilight] && this
                        .seriesPoints[b][this.prevHilight]
                        .animate(this.pointShrinkSeries(b));
            if (null !== a && this.prevHilight !== a) 
                for (
                    b     = d = 0,
                    f     = this.seriesPoints.length - 1; f >= 0
                            ? f >= d
                            : d >= f; b = f >= 0
                        ? ++d
                        : --d
                ) 
                    this.seriesPoints[b][a] && this
                        .seriesPoints[b][a]
                        .animate(this.pointGrowSeries(b));
        ...
        c.prototype.colorFor                  = function (a, b, c) {
            return "function" == typeof this.options.lineColors
                ...
                : "point" === c
                    ? this
                        .options
                        .pointFillColors[b % this.options.pointFillColors.length] || this
                        .options
                        .lineColors[b % this.options.lineColors.length]
                    : this
                        .options
                        .lineColors[b % this.options.lineColors.length]
        },
        ...
        c.prototype.pointStrokeWidthForSeries = function (a) {
            return this
                .options
                .pointStrokeWidths[a % this.options.pointStrokeWidths.length]
        },
        c.prototype.pointStrokeColorForSeries = function (a) {
            return this
                .options
                .pointStrokeColors[a % this.options.pointStrokeColors.length]
        },
        c.prototype.lineWidthForSeries        = function (a) {
            return this.options.lineWidth instanceof Array
                ? this
                    .options
                    .lineWidth[a % this.options.lineWidth.length]
        ...
        c.prototype.pointSizeForSeries        = function (a) {
            return this.options.pointSize instanceof Array
                ? this
                    .options
                    .pointSize[a % this.options.pointSize.length]
    ...
    d                  = function (a) {
        return {
            fmt  : function (a) {
                return "" + b.pad2(a.getHours()) + ":" + b.pad2(a.getMinutes()) + ":" + b.pad2(
                    a.getSeconds()
                )
            },
            incr : function (b) {
    ...
    b.LABEL_SPECS      = {
        ...
        day    : {
            fmt  : function (a) {
                return "" + a.getFullYear() + "-" + b.pad2(a.getMonth() + 1) + "-" + b.pad2(
                    a.getDate()
                )
            },
            incr : function (a) {
    ...
    b.Area             = function (c) {
        function d(c) {
            ...
            return this instanceof b.Area
                ? (
                    ...
                    "auto" === f.fillOpacity && (
                        f.fillOpacity = f.behaveLikeLine
                            ? .8
                            : 1
                    ),
            ...
            for (
                ...
                b                 = this.options.behaveLikeLine
                    ? function () {
                        ...
                        for (
                            var a = 0,
                            b     = this.options.ykeys.length - 1; b >= 0
                                    ? b >= a
                                    : a >= b; b >= 0
                                ? a++
                                : a--
                    ...
                    : function () {
                        g = [];
                        for (
                            var a     = e = this.options.ykeys.length - 1; 0 >= e
                                    ? 0 >= a
                                    : a >= 0; 0 >= e
                                ? a++
                                : a--
        ...
        d.prototype._drawFillFor   = function (a) {
            ...
            null !== b
                ? (
                    b += "L" + this.transX(this.xmax) + "," + this.bottom + "L" + this.transX(this.xmin) +
                                "," + this.bottom + "Z",
    ...
    b.Bar              = function (c) {
        ...
        d.prototype.calc               = function () {
            ...
            this.options.hideHover === !1
                ? (a = this.hover)
                    .update
                    .apply(a, this.hoverContentForRow(this.data.length - 1))
                : void 0
        },
        ...
        d.prototype.drawXAxis          = function () {
            ...
            for (
                ...
                0 !== this.options.xLabelAngle && (
                    e = -.5 * i.width * Math.cos(this.options.xLabelAngle * Math.PI / 180),
                    b.transform(
                        "t" + e + ",0..."
                    )
                ),
                (null == g || g >= c.x + c.width || null != f && f >= c.x) && c.x >= 0 && c.x + c.width < this
                    .el
                    .width()
                        ? (0 !== this.options.xLabelAngle && (
                        ...
                        for (p = i._y, q = [], j = h = 0, l = p.length; l > h; j = ++h) 
                            ...
                            null !== n
                                ? (
                                    ...
                                    k = b - m,
                                    this.options.verticalGridCondition && this.options.verticalGridCondition(i.x) && this.drawBar(
                                        this.left + d * c,
                                        this.top,
                                        c,
        ...
        d.prototype.colorFor           = function (a, b, c) {
            ...
            return "function" == typeof this.options.barColors
                ...
                : this
                    .options
                    .barColors[b % this.options.barColors.length]
        },
        ...
        d.prototype.onHoverMove        = function (a) {
            ...
            (c = this.hover)
                .update
                .apply(c, this.hoverContentForRow(b))
        },
        ...
        d.prototype.drawBar            = function (a, b, c, d, e, f, g) {
            ...
            i        = 0 === h || h > d
                ...
                : this
                    .raphael
                    .path(this.roundedRect(a, b, c, d, g)),
            i
                .attr("fill", e)
                .attr("fill-opacity", f)
                .attr("stroke", "none")
    ...
    b.Donut            = function (c) {
        function d(c) {
            ...
            if (
                ...
                this.el      = "string" == typeof c.element
                    ? a(document.getElementById(c.element))
                    : a(c.element),
                null === this.el || 0 === this.el.length
            ) 
                throw new Error("Graph placeholder not found.");
            void 0 !== c.data && 0 !== c.data.length && (
                this.raphael = new Raphael(this.el[0]),
                this.options.resize && a(window).bind("resize", function () {
    ...
    b.DonutSegment     = function (a) {
        ...
        b.prototype.drawDonutArc     = function (a, b) {
            return this
                .raphael
                .path(a)
                .attr({"stroke-width": 2, opacity: 0, stroke: b})
        },
        b.prototype.drawDonutSegment = function (a, b, c, d, e) {
            return this
                .raphael
                .path(a)
                .attr({"stroke-width": 3, fill: b, stroke: c})
                .hover(d)
                .click(e)
        },
