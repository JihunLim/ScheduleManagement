            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-primary">
                        ...
                        <a href="ClientTable.do">
                            <div class="panel-footer">
                                <span class="pull-left">내담자 생성 바로가기</span>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-green">
                        ...
                        <a href="AddNewTask.do">
                            <div class="panel-footer">
                                <span class="pull-left">과제 생성 바로가기</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-yellow">
                        ...
                        <a href="SetTracking.do">
                            <div class="panel-footer">
                                <span class="pull-left">위치 설정 바로가기</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-red">
                        ...
                        <a href="#">
                            <div class="panel-footer">
                                <span class="pull-left">데이터 베이스 관리</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> 전체 통계 간략 보기
